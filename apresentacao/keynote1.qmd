...
2. [**Júri simulado**]{} — quem responde, e por quê → [abrir](../atividades/02-juri.html)
3. [**Nomear o fenômeno**]{} — a fronteira entre termos vizinhos → [abrir](../atividades/03-fenomenos.html)
4. [**Simulado comentado**]{} — testar o que ficou → [abrir](../atividades/04-questoes.html)
5. [**Arquitetura da ação**]{} *(extra)* — planos, à la Bratman → [abrir](../atividades/05-planos.html)
:::
